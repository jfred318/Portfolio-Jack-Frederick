...
export default function App() {
  ...
  const scrollToSection = (index) => {
    const el = document.querySelector('.snap-container');
    if (!el) return;
    el.scrollTo({ top: window.innerHeight * index, behavior: 'smooth' });
  };


  const HomeSection = (
    <div className={`home-page ${isMobile ? 'mobile-section' : 'snap-section'}`}>
  ...
  const ProjectsSection = (
    <div className={isMobile ? 'mobile-section' : 'snap-section'}>
      <BlogTemplate
        title="Projects"
        posts={[
          {
  ...
  const ExperienceSection = (
    <div className={isMobile ? 'mobile-section' : 'snap-section'}>
      <ExperienceTimeline
        ...
        endYear={2025}
        experiences={[
          { title: "Identity Security Intern", start: 2024, end: 2025, description: "Worked on threat identification, security automation, and risk analysis." },
          { title: "Music Production Club Founder", start: 2023, end: 2025, description: "Created a community, organized events, and taught music production." },
          { title: "Investor", start: 2019, end: 2025, description: "Managed a five digit portfolio that has consistently beat the S&P 500" },
          { title: "Golf Instructor", start: 2022, end: 2023, description: "Worked alongside 6 professional golfers and instructors molding young kids into gifted athletes" },
          { title: "Teacher's Assistant", start: 2022, end: 2023, description: "Shadowed the school's IB Environmental class and led instructional periods" },
          { title: "Soccer Referee", start: 2018, end: 2022, description: "Regulated the speed and safety of the game following the laws of Grassroots soccer" },
          { title: "Riverwood Internation Charter School", start: 2019, end: 2023, description: "Participated in Varisty sports as well as community service and honors organizations" },
          { title: "Auburn University", start: 2023, end: 2025, description: "Studying software engineering while participating in various on-campus organizations" },
          { title: "Caddie", start: 2020, end: 2022, description: "Improved the level of play while maintaining the prestige look of the club for each member" }
        ]}
      />
    </div>
  );
  ...
  const ArtSection = (
    <div className={isMobile ? 'mobile-section' : 'snap-section'}>
      <ArtTemplate
        title="Art"
        pieces={[
          { title: "AMP Logo", src: "AMP 2.png", top: "8%", left: "8%", size: "290px" },
          { title: "Personal Logo", src: "JFLogo 2.png", top: "10%", left: "68%", size: "220px" },
          { title: "AMP Flyer", src: "Flyer4 2.png", top: "46%", left: "6%", size: "210px" },
          { title: "Niche Logo", src: "NicheLogoElement 2.png", top: "50%", left: "77%", size: "200px" },
          { title: "Swung Logo", src: "SwungLogo 2.png", top: "32%", left: "28%", size: "200px" },
          { title: "Niche Logo Alt. 2", src: "NicheLogoHexWord 2.png", top: "64%", left: "40%", size: "230px" },
          { title: "Niche Logo Alt.", src: "NicheLogoSmallTable 2.png", top: "29%", left: "51%", size: "230px" }
        ]}
      />
    </div>
  );
